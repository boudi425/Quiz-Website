    ...
    return (
        <main>
            ...
            <div className="min-h-screen">
                <section className="flex justify-center flex-col mx-auto px-4 py-8 md:px-24 lg:px-24">
                    ...
                    <div className="flex flex-col items-center justify-center mt-4 w-full">
                        ...
                        <button className={`btn-primary mt-4 w-50 disabled:bg-primary/5 transition-all duration-200 ${selectedFields.length === 0 ? "opacity-50 cursor-not-allowed" : "cursor-pointer hover:translate-y-[-2px] active:scale-95"}`}  disabled={selectedFields.length === 0} onClick={() => startQuiz(selectedFields)}>Start Quiz!</button>
